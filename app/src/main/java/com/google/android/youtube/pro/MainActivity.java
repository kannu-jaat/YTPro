...
public class MainActivity extends Activity {
    ...
    // 🎵 NAYA PLAYER AUR TOGGLE BUTTON
    private OfflinePlayerManager offlinePlayer;
    private Button btnOfflineToggle;
    ...
    private void setupDynamicLayout() {
        ...
        // 🎵 NAYA LOCAL PLAYER TOGGLE BUTTON
        btnOfflineToggle = new Button(this);
        btnOfflineToggle.setText("🎵 LOCAL");
        btnOfflineToggle.setBackgroundColor(android.graphics.Color.TRANSPARENT);
        ...
        ytHeader.addView(btnRefresh, new LinearLayout.LayoutParams(90, -1));
        ...
        ytHeader.addView(btnFullscreen, new LinearLayout.LayoutParams(90, -1));

        // 🛡️ Naya Content Container taaki Header safe rahe
        ...
        contentContainer.addView(ytHomeWeb);

        innerVertical.addView(ytHeader);
        innerVertical.addView(contentContainer);
    ...
    public void load(boolean dl) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            cookieManager.setAcceptThirdPartyCookies(ytHomeWeb, true); 
        }
    ...
    public void onDestroy() { 
        ...
        if (offlinePlayer != null) offlinePlayer.onDestroy(); // 🎵 Clear background MP3 player memory
    }
}
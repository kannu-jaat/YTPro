...
public class ForegroundService extends Service {
    ...
    private void buildAndShowNotification(boolean leftPlaying, boolean rightPlaying, boolean faderLeft, boolean faderRight) {
        ...
        builder.addAction(leftPlaying ? android.R.drawable.ic_media_pause : android.R.drawable.ic_media_play, "L", leftPI);
        builder.addAction(rightPlaying ? android.R.drawable.ic_media_pause : android.R.drawable.ic_media_play, "R", rightPI);
        builder.addAction(faderLeft ? android.R.drawable.ic_media_previous : android.R.drawable.ic_media_rew, "◀", xfLeftPI);
        builder.addAction(faderRight ? android.R.drawable.ic_media_next : android.R.drawable.ic_media_ff, "▶", xfRightPI);
        ...
        // 🛠️ Android 14 (API 34+) compatibility fix: Adding service type type explicitly
    ...
    public void onDestroy() {
        super.onDestroy();
        if (djUpdateReceiver != null) unregisterReceiver(djUpdateReceiver);
    }
